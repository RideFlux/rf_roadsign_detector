...
class RoadSignDetectorModuleProd(nn.Module):
    '''
    pointpillars_module.py와 입력단만 다름.
    Voxelization부분을 제거한 버전이고, Production 환경에서 사용하기 위한 모듈.
    '''
    def __init__(
        self,
        training_model: bool,
    ...
    def forward(self, batch_dict, mode='val', batched_gt_bboxes=None, batched_gt_labels=None):
        ...
        batch_size = len(batch_dict['voxels'])
