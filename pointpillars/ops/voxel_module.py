...
class _Voxelization(torch.autograd.Function):
    ...
    def forward(ctx,
        ...
        sorted_indices = torch.argsort(points[:, 3], descending=True)
...
class Voxelization(nn.Module):
    ...
    def forward(self, input):
        ...
        # Voxelization
        voxels, coors, num_points_per_voxel = _Voxelization.apply(
            input, self.voxel_size, self.point_cloud_range,
